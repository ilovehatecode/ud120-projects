...
for name, from_person in [("sara", from_sara), ("chris", from_chris)]:
 ...
 ##       if temp_counter < 100000:
        ...
        parsedEmail.replace("sara", "")
        parsedEmail.replace("skachleton", "")
        parsedEmail.replace("chris", "")
        parsedEmail.replace("germani", "")  
...
## Remove Stopwords in each element of word_data
